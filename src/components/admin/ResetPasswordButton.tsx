...
export function ResetPasswordButton({ adminId, email }: ResetPasswordButtonProps) {
                            ...
                            {success ? (
                                <div className="flex flex-col items-center justify-center py-8 space-y-4 animate-in zoom-in-90">
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="text-sm text-slate-400">Password has been updated.</p>
                                    </div>
                                </div>
                            ) : (
                                <form onSubmit={handleReset} className="space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-[10px] text-slate-500 px-1">Ensure the teacher is informed of the new credentials.</p>
                                    </div>
